...
class SenderLoginCommand : public LobbyServerMessageCore{
    public:
        struct data {std::string nickname; };
        std::optional<data> data_obj;
...
public:
    struct data { std::string game_id; std::string role; };
    std::optional<data> data_obj;
};
class ResponseJoinGameCommand : public LobbyServerMessageCore {
public:
    struct data { std::string status; std::string role; ShortGameInfo game_info; };
    std::optional<data> data_obj;
};
